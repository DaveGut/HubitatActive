...
04.14.20	3.0.02	New manual installation version group functions disabled.
===== HUBITAT INTEGRATION VERSION =======================================================*/
import org.json.JSONObject
def driverVer() { return "3.0.02" }

metadata {
	definition (name: "Samsung Wifi Speaker Manual",
				namespace: "davegut",
				author: "David Gutheinz",
				importUrl: "https://raw.githubusercontent.com/DaveGut/Hubitat/Samsung-Speaker/SamsungWifiSpeaker.groovy"
			   ){
		capability "Switch"
