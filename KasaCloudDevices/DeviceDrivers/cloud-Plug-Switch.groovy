...
metadata {
	definition (name: "Kasa Cloud Plug Switch",
    			namespace: "davegut",
				author: "Dave Gutheinz",
				importUrl: "https://raw.githubusercontent.com/DaveGut/HubitatActive/master/KasaCloudDevices/DeviceDrivers/cloud-Plug-Switch.groovy"
			   ) {
		capability "Switch"
		capability "Actuator"
		capability "Refresh"
