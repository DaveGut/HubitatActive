...
metadata {
	definition (name: "Replica Samsung Refrigerator icemaker",
				namespace: "replicaChild",
				author: "David Gutheinz",
				importUrl: "https://raw.githubusercontent.com/DaveGut/HubitatActive/master/HubiThingsReplica%20Drivers/Replica_Samsung_Refrigerator_icemaker.groovy"
			   ){
		capability "Switch"
		capability "Refresh"
	}
